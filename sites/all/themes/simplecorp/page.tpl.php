        ...
        <footer id="footer">
            ...
            <div id="footer-bottom">
                <div class="container clearfix">
                    ...
                    <div class="credits" style="width: 200px; float: left">
                    Design by <a href="http://www.drupalizing.com">Drupalizing</a>
                    </div>
					<div class="credits" style="float: left">
                    Aliva&nbsp;&nbsp;•&nbsp;&nbsp;Aabygade 10, DK-8300 Odder&nbsp;&nbsp;•&nbsp;&nbsp;Tlf: +45 305 302 83&nbsp;&nbsp;•&nbsp;&nbsp;Email: <a href="mailto:aliva@aliva.dk" target="_top">aliva@aliva.dk</a>
                    </div>
                </div>
            </div>
            <!-- EOF: #footer-bottom -->
